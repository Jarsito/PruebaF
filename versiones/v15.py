...
class ProductoMusical:
    ...
    def mostrar_inventario(self):
        ...
        print("{:<15} {:<15} {:<10} {:<10}".format("Marca", "Precio (USD)", "Stock", "Total"))
        print("=" * 50)
        for marca, (precio, stock) in self.marcas_precios_stock.items():
            print("{:<15} {:<15.2f} {:<10} {:<10.2f}".format(marca.capitalize(), precio, stock, precio * stock))
...
def main():
    ...
    while True:
        ...
        if producto:
            # Limpiar la consola al seleccionar una marca
            clear_console()
            ...
            input("Presione Enter para continuar...")  # Esperar a que el usuario presione Enter
    ...
    if carrito:
        ...
        print("\nTotal de la compra: ${:.2f}".format(total_compra))
        print("=" * 50)
